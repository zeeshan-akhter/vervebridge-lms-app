             ...
             templateColumns={['1fr','5fr 1fr']}>
                {
                    loading || !stats ? <Loader color="purple.500"/>:(
                        <Box
                boxSizing="border-box" py='16' px={['4','0']} >
                    ...
                    boxShadow={'-2px 0 10px rgba(107,70,193,0.5)'}>
                        ...
                        <Grid templateColumns={["1fr","2fr 1fr"]}>
                            <Box p={"4"}>
                              <Heading textAlign={['center','letf']} size={'md'} children="Progress Bar"
                              my={"8"}
                              ml={['0','16']}/> 
                              <Box>
                                 <Bar
                                 profit={viewsProfit} title="Views" value={viewsPercentage}/>
                                 <Bar 
                                 profit={usersProfit} 
                                 title="Users" value={usersPercentage}/>
                                 <Bar 
                                 profit={subscriptionProfit} 
                                 title="Subscription" value={subscriptionPercentage}/>
                                </Box>   
                            </Box>
